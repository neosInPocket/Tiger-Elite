...
public static class SaveLoad
{
	public static void Load()
	{
		...
		MainMenuController.CurrentGravityUpgrade = PlayerPrefs.GetInt("CurrentGravityUpgrade", 0);
	...
	public static void Save()
	{
		...
		PlayerPrefs.SetInt("CurrentGravityUpgrade", MainMenuController.CurrentGravityUpgrade);
